...
public class TestHele {
    public static void main(String[] args) throws InterruptedException{
        ...
        for(int i = 1; i < ikkeSykeMonitor.antSub(); i++)
            flettetSubsekvens = Monitor2.subsSmettng(flettetSubsekvens, ikkeSykeMonitor.hentSub(i));
        
        for(int i = 1; i < sykeMonitor.antSub(); i++)
            flettetSykSubsekvens = Monitor2.subsSmettng(flettetSykSubsekvens, sykeMonitor.hentSub(i));
